module github.com/fox-one/hodl

go 1.17

require (
	github.com/MixinNetwork/trusted-group/mvm v0.0.0-20211207114727-e88b1554ca93
...
require (
	...
	github.com/MixinNetwork/mixin v0.13.10-0.20211130090246-732558212cef // indirect
