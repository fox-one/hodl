...
var rootCmd = &cobra.Command{
	Use:           "hodl",
	Short:         "cli tool for hodl mvm version",
	SilenceUsage:  true,
	SilenceErrors: true,
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.hodl.yaml)")
}
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".hodl" (without extension).
